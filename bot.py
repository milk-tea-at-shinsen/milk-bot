...
class MyInteraction(discord.Interaction):
    @property
    def bot_name(self):
        return self.me.nick or self.me.display_name
...
class ReminderSelect(View):
    ...
    async def select_callback(self, interaction: discord.Interaction):
        await interaction.response.edit_message(content=f"{interaction.bot_name}が考え中…🤔", view=None)
...
class AddOptionInput(discord.ui.Modal):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.response.defer()
        await interaction.message.edit(content=f"{interaction.bot_name}が考え中…🤔", view=None)
        # 追加選択肢をリスト化
